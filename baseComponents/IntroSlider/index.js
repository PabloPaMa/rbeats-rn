...
import { StyleSheet, FlatList, View, Dimensions, Text, TouchableOpacity, Platform, I18nManager, } from 'react-native'
...
/**
 * A screen slider handler
 *
 * @export
 * @class AppIntroSlider
...
export default class AppIntroSlider extends React.Component {
  ...
  /**
   * handles the click of the prev button
   *
   * @memberof AppIntroSlider
   */
  _onPrevPress = () => {
  ...
  /**
   * renders a slide given an object
   * 
   * @param {Object} item
   * @memberof AppIntroSlider
   */
  ...
  _renderSkipButton = () =>
    ...
    this._renderButton('Skip', () => {
      console.log('this.props.onSkip', this.props.onSkip)
